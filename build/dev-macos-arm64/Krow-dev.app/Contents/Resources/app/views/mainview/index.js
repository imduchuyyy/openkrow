...
var electrobun = new Electroview({ rpc });
...
function App() {
  ...
  const [workspacePath, setWorkspacePath] = import_react.useState(null);
  const [error, setError] = import_react.useState(null);
  const [sessionId, setSessionId] = import_react.useState(null);
  ...
  const messagesEndRef = import_react.useRef(null);
  ...
  if (state !== "ready") {
    return /* @__PURE__ */ jsx_dev_runtime.jsxDEV("div", {
      className: "flex flex-col items-center justify-center h-screen bg-neutral-900 text-neutral-200 font-sans gap-6",
      children: [
        ...
        /* @__PURE__ */ jsx_dev_runtime.jsxDEV("p", {
          ...
          children: "Select a workspace folder to get started."
        }, undefined, false, undefined, this),
        /* @__PURE__ */ jsx_dev_runtime.jsxDEV("button", {
          ...
          children: state === "loading" ? "Starting..." : "Open Folder"
        }, undefined, false, undefined, this),
        error && /* @__PURE__ */ jsx_dev_runtime.jsxDEV("p", {
          className: "text-red-400 text-xs max-w-xs text-center",
          children: error
        }, undefined, false, undefined, this)
      ]
  ...
  return /* @__PURE__ */ jsx_dev_runtime.jsxDEV("div", {
    className: "flex flex-col h-screen bg-neutral-900 text-neutral-200 font-sans",
    children: [
      /* @__PURE__ */ jsx_dev_runtime.jsxDEV("div", {
        className: "flex items-center px-4 py-3 border-b border-neutral-800 shrink-0",
        ...
        children: /* @__PURE__ */ jsx_dev_runtime.jsxDEV("div", {
          ...
          children: [
            ...
            /* @__PURE__ */ jsx_dev_runtime.jsxDEV("p", {
              className: "text-xs text-neutral-500 truncate font-mono",
      ...
      /* @__PURE__ */ jsx_dev_runtime.jsxDEV("div", {
        ...
        children: [
          messages.length === 0 && /* @__PURE__ */ jsx_dev_runtime.jsxDEV("div", {
            className: "flex items-center justify-center h-full",
            children: /* @__PURE__ */ jsx_dev_runtime.jsxDEV("p", {
              className: "text-neutral-600 text-sm",
              children: "Send a message to start."
            }, undefined, false, undefined, this)
          }, undefined, false, undefined, this),
          messages.map((msg) => /* @__PURE__ */ jsx_dev_runtime.jsxDEV("div", {
            className: `flex ${msg.role === "user" ? "justify-end" : "justify-start"}`,
            children: /* @__PURE__ */ jsx_dev_runtime.jsxDEV("div", {
              className: `max-w-[80%] rounded-xl px-4 py-2.5 text-sm whitespace-pre-wrap ${msg.role === "user" ? "bg-blue-600 text-white" : "bg-neutral-800 text-neutral-200"}`,
              children: msg.text
            }, undefined, false, undefined, this)
          }, msg.id, false, undefined, this)),
          sending && /* @__PURE__ */ jsx_dev_runtime.jsxDEV("div", {
            className: "flex justify-start",
            children: /* @__PURE__ */ jsx_dev_runtime.jsxDEV("div", {
              className: "bg-neutral-800 text-neutral-400 rounded-xl px-4 py-2.5 text-sm",
              children: "Thinking..."
            }, undefined, false, undefined, this)
          }, undefined, false, undefined, this),
          /* @__PURE__ */ jsx_dev_runtime.jsxDEV("div", {
      ...
      /* @__PURE__ */ jsx_dev_runtime.jsxDEV("div", {
        className: "shrink-0 border-t border-neutral-800 px-4 py-3",
        children: /* @__PURE__ */ jsx_dev_runtime.jsxDEV("div", {
...
import_client.createRoot(document.getElementById("root")).render(/* @__PURE__ */ jsx_dev_runtime2.jsxDEV(import_react2.StrictMode, {
